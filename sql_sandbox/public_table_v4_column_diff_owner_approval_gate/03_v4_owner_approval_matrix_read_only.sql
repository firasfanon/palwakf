...
select
  'v4_owner_approval_matrix_detail' as section,
  target_schema,
  public_table,
  target_table,
  sensitivity,
  ...
  'PENDING_COLUMN_DIFF_REVIEW' as column_diff_status,
  'PENDING_VIEW_REWRITE_REVIEW' as dependency_rewrite_status,
...
select
  'v4_owner_approval_matrix_summary' as section,
  target_schema,
