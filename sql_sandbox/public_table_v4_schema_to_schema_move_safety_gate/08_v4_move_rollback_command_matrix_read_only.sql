...
select
  'v4_move_rollback_command_matrix' as section,
  public_table,
  target_schema,
  target_table,
  format('DROP VIEW IF EXISTS public.%I;', public_table) as future_drop_compat_view_sql_not_authorized,
  format('ALTER TABLE %I.%I SET SCHEMA public;', target_schema, target_table) as future_rollback_move_sql_not_authorized,
  'ROLLBACK_REQUIRES_BACKUP_REFERENCE_AND_OPERATOR_CONFIRMATION' as rollback_requirement,
  false as rollback_confirmed_by_this_script,
