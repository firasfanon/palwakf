...
select
  'v4_move_flutter_dependency_scan_operator_template' as section,
  public_table,
  target_schema,
  target_table,
  'PENDING_REPOSITORY_SCAN' as flutter_dependency_status,
  'Search Flutter/Dart code for: from(''' || public_table || '''), rpc wrappers, PostgREST direct calls, and public.' || public_table as required_scan,
