...
select
  'v4_move_public_compatibility_view_plan' as section,
  public_table,
  target_schema,
  target_table,
  format('ALTER TABLE public.%I SET SCHEMA %I;', public_table, target_schema) as future_move_sql_not_authorized,
  format('CREATE OR REPLACE VIEW public.%I AS SELECT * FROM %I.%I;', public_table, target_schema, target_table) as future_compat_view_sql_not_authorized,
  'VERIFY_VIEW_UPDATABILITY_GRANTS_RLS_AND_FUNCTION_DEPENDENCIES_BEFORE_APPLY' as required_review,
