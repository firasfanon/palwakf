with blockers(blocker_group, object_key, blocker_status, required_evidence, can_be_closed_in_balanced_pack) as (
  values
    ...
    ('grant_delta','platform_access grant deltas','OWNER_REVIEW_REQUIRED','no GRANT/REVOKE unless explicit owner approval and separate protected script',true),
...
select
  'v4_wave1_balanced_closure_blocker_carry_forward_and_risk_register'::text as section,
  blocker_group,
  object_key,
  blocker_status,
  required_evidence,
