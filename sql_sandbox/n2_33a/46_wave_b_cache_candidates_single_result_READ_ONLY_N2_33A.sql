...
-- 46_wave_b_cache_candidates_single_result_READ_ONLY_N2_33A.sql
...
checks as (
  ...
  select 'n2_32_decision', 'wave_b_cache_quarantine', 'decision', true, 0,
         'DEFER/SPLIT: split SQL evidence collection from quarantine execution. No cache table is moved/dropped/renamed in N2.33A.'
  union all
