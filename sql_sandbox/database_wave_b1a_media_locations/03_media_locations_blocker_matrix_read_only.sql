-- Database Wave B-1A — Media + Locations Blocker Matrix (READ ONLY)

select *
from (
  values
    ('media_center','media_legacy_tables','bootstrap_required','no_activation','Create/certify sovereign media runtime, RLS, editorial workflow, public/admin mapping before wrapper activation.'),
...
order by domain_key, blocker_key;
