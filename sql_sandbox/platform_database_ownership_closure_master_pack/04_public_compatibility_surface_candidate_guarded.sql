-- Platform Database Ownership Closure Master Pack — 04
-- PUBLIC COMPATIBILITY SURFACE CANDIDATE
...
select 'public_compatibility_surface_candidate_guarded' as section,
