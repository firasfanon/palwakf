        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _metaChip(
                '${items.where((e) => e.route.trim().isNotEmpty).length} مرتبطة',
                Icons.link_outlined,
              ),
            ],
          ),
...
class _HighlightCardState extends State<_HighlightCard> {
  ...
  bool get _hasRoute {
    final route = widget.item.route.trim();
  ...
  void _openRoute(BuildContext context) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('تم حفظ الرابط الخارجي وسيُفعّل في مرحلة لاحقة.'),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: InkWell(
        ...
        onTap: _hasRoute ? () => _openRoute(context) : null,
