      ...
      child: Column(
        children: [
          const PwfSectionTitle(
            ...
            subtitle:
                'متابعة الأنشطة والفعاليات والبرامج العامة التي تنظمها الوزارة ومديرياتها',
          ),
    ...
    return Column(
      children: [
        ...
        if (showViewAll) ...[
          ...
          _ViewAll(text: 'عرض جميع الأنشطة', icon: Icons.event, onTap: onTap),
        ],
      ],
    );
  }
