...
// lib/data/repositories/auth_repository.dart
  ...
  ///
  /// Platform runtime should pass the unified recovery callback URL. This
  /// repository must not define a per-system recovery screen/deep link.
      ...
      if (_ownerWriteRpcWriteRerouteEnabled) {
        await _supabaseService.client.rpc(
          ...
          params: {
            ...
            'p_patch': {
              ...updates,
              'operation': 'tasks_self_profile_update',
            },
          },
        );
        return await _getUserProfile(userId);
