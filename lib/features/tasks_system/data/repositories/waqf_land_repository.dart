...
class WaqfLandRepository {
  ...
  Future<List<WaqfLand>> getAllWaqfLands({int? limit, int? offset}) async {
    try {
      dev.log('Fetching waqf lands', name: 'WaqfLandRepository');

      var query = _supabaseService.client
          .from(PwfDatabaseOwnerSurfaces.waqfLands)
          .select()
      ...
      dev.log(
        'Successfully fetched ${(response as List).length} waqf lands',
  ...
  Future<WaqfLand?> getWaqfLandById(int id) async {
    try {
      ...
      dev.log(
        'Error fetching waqf land by ID',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<WaqfLand?> getWaqfLandByReferenceNumber(String referenceNumber) async {
    try {
      dev.log(
        'Fetching waqf land with reference: $referenceNumber',
        name: 'WaqfLandRepository',
      );
      ...
      if (response == null) {
        dev.log(
          'Waqf land not found with reference: $referenceNumber',
          name: 'WaqfLandRepository',
        );
        return null;
      }
      ...
      dev.log(
        'Error fetching waqf land by reference',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getWaqfLandsByType(LandType type, {int? limit}) async {
    try {
      dev.log(
        'Fetching waqf lands of type: ${type.name}',
        name: 'WaqfLandRepository',
      );
      ...
      dev.log(
        'Error fetching waqf lands by type',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getWaqfLandsByStatus(
    ...
    try {
      dev.log(
        'Fetching waqf lands with status: ${status.name}',
        name: 'WaqfLandRepository',
      );
      ...
      dev.log(
        'Error fetching waqf lands by status',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getWaqfLandsByOwnershipType(
    ...
    try {
      dev.log(
        'Fetching waqf lands with ownership: ${ownershipType.name}',
        name: 'WaqfLandRepository',
      );
      ...
      dev.log(
        'Error fetching waqf lands by ownership type',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getWaqfLandsByGovernorate(
    ...
    try {
      dev.log(
        'Fetching waqf lands for governorate: $governorate',
        name: 'WaqfLandRepository',
      );
      ...
      dev.log(
        'Error fetching waqf lands by governorate',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getLeasedWaqfLands({int? limit}) async {
    try {
      ...
      dev.log(
        'Error fetching leased waqf lands',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getAvailableWaqfLands({int? limit}) async {
    try {
      ...
      dev.log(
        'Error fetching available waqf lands',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> getDisputedWaqfLands({int? limit}) async {
    try {
      ...
      dev.log(
        'Error fetching disputed waqf lands',
        name: 'WaqfLandRepository',
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<List<WaqfLand>> searchWaqfLands(String query) async {
    try {
      dev.log(
        'Searching waqf lands with query: $query',
        name: 'WaqfLandRepository',
      );
      ...
      final response = await _supabaseService.client
          ...
          .select()
          .or(
            'name.ilike.%$query%,description.ilike.%$query%,reference_number.ilike.%$query%',
          )
          .order('created_at', ascending: false);
  ...
  Future<WaqfLand> createWaqfLand(WaqfLand waqfLand) async {
    try {
      dev.log(
        'Creating new waqf land: ${waqfLand.referenceNumber}',
        name: 'WaqfLandRepository',
      );
      ...
      dev.log(
        'Waqf land created successfully with ID: ${response['id']}',
        name: 'WaqfLandRepository',
      );
  ...
  Future<WaqfLand> updateWaqfLandStatus(int id, LandStatus status) async {
    try {
      dev.log(
        'Updating waqf land status to: ${status.name}',
        name: 'WaqfLandRepository',
      );
  ...
  Future<WaqfLand> updateLeasingInfo(int id, LeasingInfo leasingInfo) async {
    try {
      dev.log(
        'Updating leasing info for waqf land: $id',
        name: 'WaqfLandRepository',
      );
  ...
  Future<WaqfLand> removeLeasingInfo(int id) async {
    try {
      dev.log(
        'Removing leasing info for waqf land: $id',
        name: 'WaqfLandRepository',
      );
  ...
  Future<WaqfLand> updateLastInspection(int id) async {
    try {
      dev.log(
        'Updating last inspection date for waqf land: $id',
        name: 'WaqfLandRepository',
      );
  ...
  Future<Map<String, dynamic>> getWaqfLandStatistics() async {
    try {
      ...
      return {
        ...
        'available': allLands
            .where((l) => l.status == LandStatus.available)
            .length,
        'disputed': allLands
            .where((l) => l.status == LandStatus.disputed)
            .length,
        'by_type': {
        ...
        'by_ownership': {
          for (var ownership in OwnershipType.values)
            ownership.name: allLands
                .where((l) => l.ownershipType == ownership)
                .length,
        },
