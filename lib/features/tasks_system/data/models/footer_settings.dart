...
class FooterLink {
  ...
  FooterLink({required this.label, required this.route, this.enabled = true});
  ...
  FooterLink copyWith({String? label, String? route, bool? enabled}) {
    return FooterLink(
...
class FooterPartner {
  ...
  FooterPartner({required this.name, this.logoUrl, this.enabled = true});
  ...
  FooterPartner copyWith({String? name, String? logoUrl, bool? enabled}) {
