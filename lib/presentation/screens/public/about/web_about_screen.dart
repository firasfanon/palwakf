      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Icon(icon, size: 20, color: AppConstants.islamicGreen),
          ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildContactItem(icon: Icons.phone, text: '+970-2-2406340'),
            const SizedBox(height: 16),
            _buildContactItem(icon: Icons.email, text: 'info@awqaf.ps'),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              content,
              style: AppTextStyles.titleMedium.copyWith(height: 1.8),
              textAlign: TextAlign.center,
            ),
          ],
        ),
