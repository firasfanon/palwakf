        ...
        Wrap(
          ...
          children: [
            AppFilterChip(
              ...
              onSelected: () =>
                  ref.read(activitiesFilterProvider.notifier).setCategory(null),
            ...
            ...ActivityCategory.values.map(
              (c) => AppFilterChip(
                ...
                onSelected: () =>
                    ref.read(activitiesFilterProvider.notifier).setCategory(c),
                onDarkBackground: true,
              ),
            ),
          ],
        ...
        Wrap(
          ...
          children: [
            AppFilterChip(
              ...
              onSelected: () =>
                  ref.read(activitiesFilterProvider.notifier).setStatus(null),
              onDarkBackground: true,
            ),
            ...ActivityStatus.values.map(
              (s) => AppFilterChip(
                ...
                onSelected: () =>
                    ref.read(activitiesFilterProvider.notifier).setStatus(s),
                onDarkBackground: true,
              ),
            ),
          ],
          ...
          data: (items) {
            if (items.isEmpty) {
              return _EmptyState(
                ...
                onClear: () =>
                    ref.read(activitiesFilterProvider.notifier).clear(),
                showClear:
                    filter.searchQuery.trim().isNotEmpty ||
                    filter.category != null ||
                    filter.status != null,
                  ...
                  Align(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () => ref.invalidate(
                        filteredActivitiesForUnitProvider(unitSlug),
                      ),
          ...
          children: [
            Row(
              children: [
                ...
                _Pill(text: _statusPill(activity.status), icon: Icons.event),
              ],
            ),
