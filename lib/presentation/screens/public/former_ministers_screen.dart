  ...
  Widget build(BuildContext context) {
    if (kIsWeb) {
      return WebPublicPage(
        ...
        subtitle: 'توثيق موجز لتعاقب الوزراء ودورهم في تطوير الوزارة',
        child: Directionality(
          ...
          child: Column(
            ...
            children: [
              ...
              ..._getFormerMinisters().map(
                (minister) => _buildMinisterCard(minister),
              ),
            ],
          ),
        ),
    ...
    return [
      {
        ...
        'period': '2019 - 2023',
        'description':
            'عمل على تطوير البنية التحتية للمساجد وتحديث الأنظمة الإلكترونية',
        'achievements': [
