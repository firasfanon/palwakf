...
class _WebServicesScreenState extends State<WebServicesScreen> {
  ...
  final List<Map<String, dynamic>> _services = [
    ...
    },
    {
      ...
      'title': 'طلب دعم مالي',
      'description':
          'تقديم طلب للحصول على دعم مالي للمساجد أو المشاريع الوقفية',
  ...
  Widget _buildStatsSection() {
    ...
    final availableCount = filteredServices
        .where((s) => s['status'] == 'متاح')
        .length;
    final categoriesCount = filteredServices
        .map((s) => s['category'])
        .toSet()
        .length;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      ...(service['requirements'] as List<String>).map(
                        (req) => Padding(
  ...
  List<Map<String, dynamic>> _getFilteredServices() {
    return _services.where((service) {
      ...
      final matchesSearch =
          ...
          (service['title'] as String).toLowerCase().contains(
            _searchQuery.toLowerCase(),
          ) ||
          (service['description'] as String).toLowerCase().contains(
            _searchQuery.toLowerCase(),
          );
