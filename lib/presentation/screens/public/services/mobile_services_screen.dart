        ...
        itemBuilder: (context, index) {
          return AnimationConfiguration.staggeredGrid(
            ...
            child: ScaleAnimation(
              child: FadeInAnimation(child: _buildServiceCard(services[index])),
            ),
          );
        },
      ),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text(
              'للتسجيل في هذه الخدمة، يرجى زيارة أقرب مكتب أوقاف أو الاتصال بالرقم التالي:',
            ),
            const SizedBox(height: 8),
  ...
  void _showAppointmentDialog(ServiceItem service) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(service.title),
        content: const Text(
          'لحجز موعد، يرجى الاتصال بسكرتارية الوزير على الرقم التالي خلال ساعات العمل الرسمية.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
...
class _EServicesScreenState extends State<EServicesScreen> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Icon(Icons.computer, color: Colors.white, size: 40),
                  const SizedBox(height: 12),
                  Text(
                    'الخدمات الإلكترونية',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'للحصول على المساعدة في استخدام الخدمات الإلكترونية:',
                  ),
                  const SizedBox(height: 8),
  ...
  Widget _buildFormsList() {
    ...
    return Column(children: forms.map((form) => _buildFormCard(form)).toList());
  }
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(form.icon, color: AppConstants.islamicGreen),
        ),
        title: Text(
          form.title,
...
enum ServiceType { form, registration, appointment, consultation, external }
