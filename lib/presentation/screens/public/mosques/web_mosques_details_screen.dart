      ...
      child: WebContainer(
        child: mosquesAsync.when(
          data: (mosques) {
            ...
            final jamiaCount = filteredMosques
                .where((m) => m.type == MosqueType.jamia)
                .length;
            final masjidCount = filteredMosques
                .where((m) => m.type == MosqueType.masjid)
                .length;
            final musallaCount = filteredMosques
                .where((m) => m.type == MosqueType.musalla)
                .length;
              ...
              children: [
                ...
                Expanded(
                  child: _buildStatCard(
                    ...
                    onTap: () =>
                        setState(() => _selectedType = MosqueType.jamia),
                  ),
                ),
                const SizedBox(width: 24),
                Expanded(
                  child: _buildStatCard(
                    ...
                    onTap: () =>
                        setState(() => _selectedType = MosqueType.masjid),
                  ),
                ),
                const SizedBox(width: 24),
                Expanded(
                  child: _buildStatCard(
                    ...
                    onTap: () =>
                        setState(() => _selectedType = MosqueType.musalla),
                  ),
                ),
              ],
            );
        ...
        child: mosquesAsync.when(
          data: (mosques) {
            ...
            return Row(
              ...
              children: [
                // Sidebar Filters
                SizedBox(width: 280, child: _buildFiltersSidebar(mosques)),
  ...
  List<Mosque> _getFilteredMosques(List<Mosque> mosques) {
    return mosques.where((mosque) {
      ...
      final matchesSearch =
          ...
          mosque.location.address.toLowerCase().contains(
