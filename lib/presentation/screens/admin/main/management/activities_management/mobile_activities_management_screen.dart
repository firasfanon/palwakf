  ...
  static List<Activity> _getSampleActivities() {
    return [
      Activity(
        ...
        description:
            'دورة مكثفة لتحفيظ القرآن الكريم للأطفال من سن 6-12 سنة مع تعليم التجويد والتلاوة الصحيحة',
      ...
      Activity(
        ...
        description:
            'محاضرة علمية حول مفهوم الوسطية في الإسلام ودورها في بناء المجتمع المسلم',
      ...
      Activity(
        ...
        description:
            'مسابقة سنوية لحفظ الأحاديث النبوية الشريفة للشباب والشابات',
        category: ActivityCategory.religious,
