            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.bodySmall?.copyWith(color: AppConstants.warning),
                ),
              ],
            ),
          ),
          TextButton(onPressed: onSave, child: const Text('حفظ الآن')),
          const SizedBox(width: 8),
          OutlinedButton(onPressed: onReset, child: const Text('تراجع')),
        ],
      ),
    );
  }
