...
class MobileAdminDashboard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MobileAdminDashboard> createState() =>
...
class _AdminDashboardScreenState extends ConsumerState<MobileAdminDashboard> {
  ...
  Widget _buildWelcomeSection(dynamic currentUser) {
    return Container(
  ...
  Widget _buildBottomNavigation() {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.gavel), label: 'القضايا'),
        BottomNavigationBarItem(icon: Icon(Icons.landscape), label: 'الأوقاف'),
        BottomNavigationBarItem(icon: Icon(Icons.folder), label: 'الوثائق'),
