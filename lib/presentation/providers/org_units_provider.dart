...
final orgUnitsListProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
  return ref
      .read(orgUnitsRepositoryProvider)
      .fetchUnitsWithProfiles(onlyActive: false);
});

final filteredOrgUnitsProvider =
