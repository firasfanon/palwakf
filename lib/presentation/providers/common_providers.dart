...
final mosquesByTypeProvider = FutureProvider.family<List<Mosque>, MosqueType>((
  ref,
  type,
) async {
  final repository = ref.watch(mosqueRepositoryProvider);
...
final mosquesSearchProvider = FutureProvider.family<List<Mosque>, String>((
  ref,
  query,
) async {
  final repository = ref.watch(mosqueRepositoryProvider);
...
final nearbyMosquesProvider =
    FutureProvider.family<List<Mosque>, NearbyMosquesParams>((
      ref,
      params,
    ) async {
      final repository = ref.watch(mosqueRepositoryProvider);
...
final mosqueStatisticsProvider = FutureProvider<Map<String, dynamic>>((
  ref,
) async {
  final repository = ref.watch(mosqueRepositoryProvider);
