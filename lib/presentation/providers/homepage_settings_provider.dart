...
// FIXED: Use supabaseServiceProvider instead of direct Supabase.instance access
final homepageRepositoryProvider = Provider<HomepageRepository>((ref) {
  final supabaseService = ref.watch(supabaseServiceProvider);
  return HomepageRepository(supabaseService.client);
});
...
/// Backward-compatible default provider for the ministry home page.
final allHomepageSectionsProvider = FutureProvider<List<HomepageSection>>((
  ref,
) async {
  return ref.watch(homepageSectionsForUnitProvider('home').future);
});

/// Provider for minister section settings
final ministerSectionProvider = FutureProvider<MinisterSectionSettings?>((
  ref,
) async {
  final repository = ref.watch(homepageRepositoryProvider);
...
final statisticsSectionProvider = FutureProvider<StatisticsSectionSettings?>((
  ref,
) async {
  final repository = ref.watch(homepageRepositoryProvider);
...
final scopedStatisticsSectionProvider =
    FutureProvider.family<StatisticsSectionSettings?, String>((
      ref,
      unitSlug,
    ) async {
      final repository = ref.watch(homepageRepositoryProvider);
...
final newsSectionProvider = FutureProvider<NewsSectionSettings?>((ref) async {
  final repository = ref.watch(homepageRepositoryProvider);
...
final statisticsSectionNotifierProvider =
    StateNotifierProvider<StatisticsSectionNotifier, StatisticsSectionState>((
      ref,
    ) {
      final repository = ref.watch(homepageRepositoryProvider);
...
final announcementsSectionNotifierProvider =
    StateNotifierProvider<
      AnnouncementsSectionNotifier,
...
class BreakingNewsSectionNotifier
    extends StateNotifier<BreakingNewsSectionState> {
  final HomepageRepository _repository;
...
final breakingNewsSectionNotifierProvider =
    StateNotifierProvider<
      BreakingNewsSectionNotifier,
      BreakingNewsSectionState
    >((ref) {
      final repository = ref.watch(homepageRepositoryProvider);
