...
final fridaySermonsRepositoryProvider = Provider<FridaySermonsRepository>((
  ref,
) {
  return FridaySermonsRepository(Supabase.instance.client);
});

final publicFridaySermonsProvider = FutureProvider<List<FridaySermon>>((
  ref,
) async {
  return ref.read(fridaySermonsRepositoryProvider).listPublic();
});

final adminFridaySermonsProvider = FutureProvider<List<FridaySermon>>((
  ref,
) async {
