...
class StatusBadge extends StatelessWidget {
  ...
  factory StatusBadge.active({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  factory StatusBadge.inactive({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  factory StatusBadge.pending({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  factory StatusBadge.completed({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  factory StatusBadge.cancelled({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  factory StatusBadge.urgent({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  /// Upcoming status
  factory StatusBadge.upcoming({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  /// Ongoing status
  factory StatusBadge.ongoing({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  /// Postponed status
  factory StatusBadge.postponed({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  /// Disputed status
  factory StatusBadge.disputed({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
  ...
  /// Leased status
  factory StatusBadge.leased({required String label, VoidCallback? onTap}) {
    return StatusBadge(
      label: label,
...
class PriorityBadge extends StatelessWidget {
  ...
  const PriorityBadge({super.key, required this.label, required this.priority});
