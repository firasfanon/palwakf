...
class CategoryBadge extends StatelessWidget {
  ...
  factory CategoryBadge.primary({required String label, VoidCallback? onTap}) {
    return CategoryBadge(
      label: label,
      backgroundColor: AppConstants.islamicGreen.withValues(alpha: 0.1),
      textColor: AppConstants.islamicGreen,
  ...
  /// Error/warning badge
  factory CategoryBadge.error({required String label, VoidCallback? onTap}) {
    return CategoryBadge(
      label: label,
  ...
  /// Success badge
  factory CategoryBadge.success({required String label, VoidCallback? onTap}) {
    return CategoryBadge(
      label: label,
  ...
  /// Warning badge
  factory CategoryBadge.warning({required String label, VoidCallback? onTap}) {
    return CategoryBadge(
      label: label,
  ...
  /// Info badge
  factory CategoryBadge.info({required String label, VoidCallback? onTap}) {
    return CategoryBadge(
      label: label,
