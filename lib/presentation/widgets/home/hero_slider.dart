...
import '../../../data/repositories/homepage_repository.dart' show HeroSlide;
...
final heroSlidesProvider = FutureProvider<List<HeroSlide>>((ref) async {
  return ref.watch(heroSlidesForUnitProvider('home').future);
});

class HeroSlider extends ConsumerStatefulWidget {
  final String unitSlug;

  const HeroSlider({super.key, this.unitSlug = 'home'});
...
class _HeroSliderState extends ConsumerState<HeroSlider> {
  ...
  void _startAutoPlay() {
    ...
    _autoPlayTimer = Timer.periodic(const Duration(seconds: 5), (timer) {
      ...
      final slidesAsync = ref.read(heroSlidesForUnitProvider(widget.unitSlug));
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: _currentPage == index
                              ? [
                                  BoxShadow(
                                    color: AppConstants.goldenYellow.withValues(
                                      alpha: 0.5,
                                    ),
                                    blurRadius: 8,
      ...
      children: [
        ...
        Positioned.fill(
          child: PwfPublicImage(
            ...
            fit: BoxFit.cover,
            fallbackColor: AppConstants.islamicGreen,
          ),
        ),
                          ...
                          children: [
                            ...
                            ElevatedButton.icon(
                              onPressed: () => context.go(
                                slide.ctaLink.isEmpty ? '/' : slide.ctaLink,
                              ), // ← Default route
                            ...
                            if (slide.ctaText.isNotEmpty && slide.ctaLink.isNotEmpty)
                              ElevatedButton.icon(
                                onPressed: () =>
                                    context.go(slide.ctaLink),  // ← Add !
                                icon: const Icon(Icons.article),
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () {
                  ref.invalidate(heroSlidesForUnitProvider(widget.unitSlug));
                },
