...
FooterSettings _$FooterSettingsFromJson(
  ...
  workingHours: json['working_hours'] as String? ?? '8:00 صباحاً - 3:00 مساءً',
  ...
  quickLinks:
      (json['quick_links'] as List<dynamic>?)
  ...
  servicesLinks:
      ...
      const [],
  bottomLinks:
      (json['bottom_links'] as List<dynamic>?)
          ?.map((e) => FooterLink.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  partners:
  ...
  developerCredit:
      json['developer_credit'] as String? ??
