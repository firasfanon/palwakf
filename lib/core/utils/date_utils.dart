...
class AppDateUtils {
  ...
  /// Alias used across the app for a standard date label.
  /// Currently mapped to short Arabic format for consistency.
  static String formatDate(DateTime date) => formatShortArabicDate(date);
