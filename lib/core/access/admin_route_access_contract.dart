...
class AdminRouteAccessContracts {
  ...
  static const contracts = <AdminRouteAccessContract>[
    ...
    AdminRouteAccessContract(
      routePrefix: '/admin/unit-media-center',
      ...
      labelAr: 'المركز الإعلامي للوحدة',
      scopePolicyAr: 'تحرير محلي ضمن الوحدة التنظيمية ونطاق التحرير الفعلي.',
    ),
    AdminRouteAccessContract(
      routePrefix: '/admin/unit-operations',
      systemKey: SystemKey.platformAdmin,
      minRole: UserRole.admin,
      readPermission: Permission.manageHome,
      writePermissions: {Permission.manageHome, Permission.manageSystems},
      labelAr: 'التشغيل والنشر للوحدات',
      scopePolicyAr: 'وحدة محددة أو صلاحية مركزية؛ لا يثبت النشر إلا بقراءة Runtime.',
    ),
    AdminRouteAccessContract(
      routePrefix: '/admin/unit-pages-execution',
      systemKey: SystemKey.platformAdmin,
      minRole: UserRole.admin,
      readPermission: Permission.manageHome,
      writePermissions: {Permission.manageHome, Permission.manageSite},
      labelAr: 'تنفيذ صفحات الوحدات',
      scopePolicyAr: 'تركيب واجهات وحدوية ضمن الأقسام المسموح بها ونطاق المستخدم.',
    ),
    AdminRouteAccessContract(
      routePrefix: '/admin/activities',
      systemKey: SystemKey.site,
      minRole: UserRole.user,
      readPermission: Permission.read,
      writePermissions: {Permission.create, Permission.update, Permission.manageSite},
      labelAr: 'اختصار الأنشطة',
      scopePolicyAr: 'Alias إعلامي يوجّه إلى مسار الأنشطة التشغيلي المعتمد.',
    ),
    AdminRouteAccessContract(
