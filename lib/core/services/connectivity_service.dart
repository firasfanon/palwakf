...
class ConnectivityService {
  ...
  static String getConnectivityDescription() {
    ...
    if (_currentStatuses.contains(ConnectivityResult.ethernet))
      types.add('إيثرنت');
    if (_currentStatuses.contains(ConnectivityResult.bluetooth))
      types.add('بلوتوث');
    if (_currentStatuses.contains(ConnectivityResult.vpn)) types.add('VPN');
    if (_currentStatuses.contains(ConnectivityResult.other))
      types.add('شبكة أخرى');
  ...
  static ConnectivityResult _pickPrimary(Set<ConnectivityResult> set) {
    ...
    if (set.contains(ConnectivityResult.ethernet))
      return ConnectivityResult.ethernet;
    if (set.contains(ConnectivityResult.mobile))
      return ConnectivityResult.mobile;
    if (set.contains(ConnectivityResult.vpn)) return ConnectivityResult.vpn;
    if (set.contains(ConnectivityResult.bluetooth))
...
class OfflineIndicator extends StatelessWidget {
  ...
  const OfflineIndicator({super.key, required this.child, this.message});
