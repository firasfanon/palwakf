...
class _PwfWebPageScaffoldState extends ConsumerState<PwfWebPageScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        // Keep HTML identity; only swap surface for dark mode so the change is
        // obvious even for sections that use fixed palette colors.
                ...
                Positioned.fill(
                  child: CustomScrollView(
                    ...
                    slivers: [
                      ...
                      if (widget.showTitleSection &&
                          (widget.title?.trim().isNotEmpty ?? false))
                        SliverToBoxAdapter(
                          child: _TitleSection(title: widget.title!),
                        ),
...
class _PwfStickyHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  static const double _extent = 210;
