          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  FaIcon(widget.item.icon, size: 44, color: accentColor),
                  const SizedBox(height: 18),
                  Text(
                    widget.item.title,
                    ...
                    onTap: () {
                      ...
                      if (link.isEmpty || link.startsWith('#')) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('قيد الربط داخل الصفحة'),
                          ),
                        );
                        return;
                      }
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'تم حفظ الرابط الخارجي وسيُفعّل في مرحلة لاحقة.',
                          ),
                        ),
                      );
                    },
...
const List<_PwfEServiceItem> _defaultItems = <_PwfEServiceItem>[
  _PwfEServiceItem(
  ...
  _PwfEServiceItem(
    ...
    description:
        'إدارة وتأجير واستثمار العقارات الوقفية التابعة للوزارة والوحدات.',
  ...
  _PwfEServiceItem(
    ...
    description: 'نماذج عامة وطلبات مرتبطة بخدمات الوزارة والوحدات التابعة.',
