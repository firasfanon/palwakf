        ...
        child: Column(
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (_, i) => _PwfStatCard(item: items[i]),
            ),
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            FaIcon(widget.item.icon, size: 38, color: PwfHomePalette.primary),
...
const List<_PwfStatItem> _defaults = <_PwfStatItem>[
  _PwfStatItem(
